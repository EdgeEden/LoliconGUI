...
basic_url = 'https://api.lolicon.app/setu/?apikey={}&r18={}'
# 主窗口中会用到的全局变量
var = tk.StringVar
info = tk.Listbox
r18 = tk.StringVar
...
def get_info(apikey='', r18=0):
    url = basic_url.format(apikey, r18)
...
def run_thread():
    ...
    apikey = get_apikey()
    r18 = get_r18()
    t = threading.Thread(target=run, args=(apikey, r18))
    t.start()
